...
<head>
    ...
    <link href="{{asset('frontend/css/font-awesome.css')}}" rel="stylesheet"> <!-- Font-Awesome-Icons-CSS -->
    <link rel="stylesheet" href="{{asset('frontend/css/swipebox.css')}}"> <!-- For-Gallery-Swipebox-CSS -->
    <!-- //Custom-Files -->
        ...
        <div class="w3l-grids-about">
            <div class="col-md-5 w3ls-ab-right">
                <div class="agile-about-right-img">
                    <img src="../../../public/frontend/images/ab.jpg" alt="">
                </div>
            </div>
            ...
            <div class="filtr-container">
                <div class="col-md-3 filtr-item" data-category="1, 4" data-sort="Busy streets">
                    <div class="agileits-img">
                        <a href="../../../public/frontend/images/g55.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/g5.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                    <div class="agileits-img">
                        <a href="../../../public/frontend/images/g33.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/g3.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                </div>
                <div class="col-md-6 filtr-item" data-category="2, 3" data-sort="Luminous night">
                    <a href="../../../public/frontend/images/g11.jpg" class="swipebox" title="My Project">
                        <img src="../../../public/frontend/images/g1.jpg" alt="" class="img-responsive img-style row2" />
                    </a>
                    <div class="col-md-6 agileits-img g2">
                        <a href="../../../public/frontend/images/g88.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/pro8.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                    <div class="col-md-6 agileits-img g4">
                        <a href="../../../public/frontend/images/g77.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/pro6.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                    <div class="clearfix"> </div>
                    <a href="../../../public/frontend/images/g22.jpg" class="swipebox" title="My Project">
                        <img src="../../../public/frontend/images/g2.jpg" alt="" class="img-responsive img-style row2" />
                    </a>
                </div>
                <div class="col-md-3 filtr-item" data-category="1, 4" data-sort="Busy streets">
                    <div class="agileits-img">
                        <a href="../../../public/frontend/images/g44.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/g4.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                    <div class="agileits-img">
                        <a href="../../../public/frontend/images/g66.jpg" class="swipebox" title="My Project">
                            <img src="../../../public/frontend/images/g6.jpg" alt="" class="img-responsive img-style row2" />
                        </a>
                    </div>
                </div>
                <div class="clearfix"> </div>
...
<script type="text/javascript" src="{{asset('frontend/js/jquery-2.1.4.min.js')}}"></script> <!-- Default-JavaScript-File -->
...
<script src="{{asset('frontend/js/jquery.adipoli.min.js')}}" type="text/javascript"></script>
<script type="text/javascript">
    $(function(){
        $('.row2').adipoli({
            'startEffect' : 'overlay',
